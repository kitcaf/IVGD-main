...
sparse_graph_properties = [
        ...
        'node_names', 'attr_names', 'class_names', 'metadata', 
        'prob_matrix', 'influ_mat_list'
        ]
...
class SparseGraph:
    ...
    def __init__(
        ...
        # if prob_matrix.shape[0] != prob_matrix.shape[1]:
            # raise ValueError("Dimensions of the probability matrix don't agree.")
...
def create_subgraph(
    ...
    sparse_graph.adj_matrix = sparse_graph.adj_matrix[nodes_to_keep][:, nodes_to_keep] # delete some nodes, keep some nodes.
    # sparse_graph.prob_matrix = sparse_graph.prob_matrix[nodes_to_keep][:, nodes_to_keep]
    # assert sparse_graph.prob_matrix.shape == sparse_graph.adj_matrix.shape, "prob matrix shape != adj matrix shape"
